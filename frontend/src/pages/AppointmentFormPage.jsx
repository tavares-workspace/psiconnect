  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (form.recorrencia && res.data.recorrentes > 0) {
        setSucesso(`Agendado! ${res.data.recorrentes + 1} sessões criadas (recorrência ${form.recorrencia}).`);
    ...
    <div className="max-w-md">
      ...
      <div className="card">
        <p className="text-xs text-gray-400 mb-4">
          Duração fixa de 60 min · Link do Google Meet gerado automaticamente
        </p>
            ...
            <div>
              ...
              {form.recorrencia && (
                <p className="text-xs text-brand-600 mt-1">
                  {form.recorrencia === 'semanal'   && '13 sessões no total (≈ 3 meses)'}
                  {form.recorrencia === 'quinzenal' && '7 sessões no total (≈ 3 meses)'}
                  {form.recorrencia === 'mensal'    && '7 sessões no total (≈ 6 meses)'}
                </p>
              )}
            </div>
          )}
