...
export default function RemindersPage() {
  ...
  async function handleSalvar() {
    ...
    if (new Date(form.remind_at) <= new Date()) { setErro('A data do lembrete deve ser futura.'); return; }
    setSalvando(true);
    try {
      ...
      <Modal isOpen={modal} onClose={() => setModal(false)} title="Novo lembrete">
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">Deve ser uma data futura.</p>
          </div>
