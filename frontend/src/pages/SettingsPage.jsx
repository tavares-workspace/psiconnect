...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-lg space-y-5">
      ...
      <div className="card">
        ...
        {calendarConectado === null ? (
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={handleDesconectar} className="text-xs text-gray-400 hover:text-red-500 underline">
              Desconectar
            </button>
          </div>
        ) : (
      ...
      <div className="card">
        <h3 className="font-semibold text-gray-800 mb-3">Encerrar conta</h3>
        <button onClick={handleExcluirConta} className="text-sm text-gray-400 hover:text-red-500 underline">
          Excluir minha conta
        </button>
      </div>
    </div>
