...
async function listar(userId, dataInicio, dataFim, status, patientId) {
  return await appointmentModel.findAll(userId, dataInicio || null, dataFim || null, status || null, patientId || null);
}
